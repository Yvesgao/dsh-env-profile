...
//   SessionEvent = { type, seq, time, data, ... }  —— 载荷在 data 下！
//   data(tool/call)   { turn, step, callId, name, arguments }   —— 工具名只在这里
//   data(tool/result) { turn, step, message: { content: [{ toolCallId }] }, error?, meta? }
//   data(turn/end)    { turn }                                   —— 强制落盘点
